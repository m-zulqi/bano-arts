  ...
  return (
    ...
    >
      <div className="relative">
        ...
        {/* Pulse Animation */}
        <span className="absolute -inset-0.5 animate-ping bg-green-500 rounded-full opacity-75"></span>
      </div>
      
      <span className="font-medium text-sm whitespace-nowrap opacity-100 group-hover:opacity-100 transition-opacity duration-300">
        Chat with us
      </span>
    </motion.button>
  )
