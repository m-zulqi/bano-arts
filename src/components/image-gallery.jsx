  ...
  return (
    <section className="py-20 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-6 text-balance">Featured Artworks</h2>
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto text-pretty">
            Discover a curated selection of calligraphy and contemporary art pieces that showcase the beauty of
            traditional and modern artistic expression.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {featuredArtworks.map((artwork, index) => (
            <motion.div
              ...
              className="group relative overflow-hidden rounded-3xl bg-gradient-to-br from-primary/20 to-accent/20 p-6 hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2"
            >
              {/* Frame Effect */}
