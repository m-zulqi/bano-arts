...
<span className="relative text-3xl sm:text-4xl md:text-[6rem] font-extrabold text-[#fea900] leading-tight drop-shadow-[0_2px_8px_rgba(0,0,0,0.7)] tracking-wide block">
                    Bano Arts
                  </span>
                  <div className="absolute inset-0 mix-blend-overlay"></div>
                </div>
<span className="block text-base sm:text-xl md:text-3xl font-normal text-[#4e3d0e] mt-1">                  "Art That Consoles You"
                </span>
              </h1>
            </motion.div>
          </motion.div>
