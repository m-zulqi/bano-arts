...
<h1 className="font-sans text-center">
  <div className="relative">
    <span className="absolute -inset-0.5"></span>
    <span className="relative text-6xl sm:text-8xl md:text-[12rem] font-extrabold text-[#fea900] leading-none drop-shadow-[0_4px_15px_rgba(0,0,0,0.95)] tracking-wider block">
      Bano Arts
    </span>
    <div className="absolute inset-0 mix-blend-overlay"></div>
  </div>
  <span className="block text-xl sm:text-2xl md:text-3xl font-normal text-[#4e3d0e] mt-2">
